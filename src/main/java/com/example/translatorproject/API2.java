...
public class API2 {
    ...
    public static String Post2(String Word) throws IOException {
    ...
    public static String translate2(String word) {
        try {
            String response = Post2(word); // Assuming Post method is non-static now
    ...
    public static void main(String[] args) {
        ...
        System.out.println(translate2(word));
    }
}